...
Simple recurrent neural network evolutionary algorithm, evolves agents to balance their need for energy acquisition and fleeing from predators, which deduct their energy upon contact.
